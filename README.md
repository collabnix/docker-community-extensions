...
| Volumes Backup & Share | Backup, clone, restore, and share Docker volumes effortlessly | [Link](https://hub.docker.com/extensions/docker/volumes-backup-extension) | ![Docker Pulls](https://img.shields.io/docker/pulls/docker/volumes-backup-extension) |
